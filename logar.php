...
$params = "email=". $_POST['email'] . "&senha=" . md5($_POST['senha']) ;
curl_setopt($cr, CURLOPT_URL, 'http://localhost/api_eventos/api/usuario/login.php'.'?'.$params);
